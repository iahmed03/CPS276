...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'iahmed3';//this will be your WCC username
      $dbUsr = 'iahmed3';//this will be your WCC username
      $dbPass = 'GS6E5263q53H';//this will be the password found in the video.
